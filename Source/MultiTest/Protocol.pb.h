...
class S_LOGIN final :
 ...
 public:
  ...
  enum : int {
    ...
    kConnectingPlayerIndexFieldNumber = 2,
    kSuccessFieldNumber = 1,
  };
  // repeated .Protocol.Player player = 3;
  ...
  void clear_connectingplayerindex();
  uint64_t connectingplayerindex() const;
  void set_connectingplayerindex(uint64_t value);
  private:
  uint64_t _internal_connectingplayerindex() const;
  void _internal_set_connectingplayerindex(uint64_t value);
  public:
 ...
 private:
  ...
  struct Impl_ {
    ...
    uint64_t connectingplayerindex_;
    bool success_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
...
class C_MOVE final :
 ...
 public:
  ...
  void clear_xrot();
  double xrot() const;
  void set_xrot(double value);
  private:
  double _internal_xrot() const;
  void _internal_set_xrot(double value);
  public:

  // double yRot = 6;
  void clear_yrot();
  double yrot() const;
  void set_yrot(double value);
  private:
  double _internal_yrot() const;
  void _internal_set_yrot(double value);
  public:

  // double zRot = 7;
  void clear_zrot();
  double zrot() const;
  void set_zrot(double value);
  private:
  double _internal_zrot() const;
  void _internal_set_zrot(double value);
  public:
...
// uint64 ConnectingPlayerIndex = 2;
inline void S_LOGIN::clear_connectingplayerindex() {
  _impl_.connectingplayerindex_ = uint64_t{0u};
}
inline uint64_t S_LOGIN::_internal_connectingplayerindex() const {
  return _impl_.connectingplayerindex_;
}
inline uint64_t S_LOGIN::connectingplayerindex() const {
  // @@protoc_insertion_point(field_get:Protocol.S_LOGIN.ConnectingPlayerIndex)
  return _internal_connectingplayerindex();
}
inline void S_LOGIN::_internal_set_connectingplayerindex(uint64_t value) {
  
  _impl_.connectingplayerindex_ = value;
}
inline void S_LOGIN::set_connectingplayerindex(uint64_t value) {
  _internal_set_connectingplayerindex(value);
  // @@protoc_insertion_point(field_set:Protocol.S_LOGIN.ConnectingPlayerIndex)
}
...
// repeated .Protocol.Player player = 2;
inline int S_ENTER_GAME::_internal_player_size() const {
  return _impl_.player_.size();
}
inline int S_ENTER_GAME::player_size() const {
  return _internal_player_size();
}
inline void S_ENTER_GAME::clear_player() {
  _impl_.player_.Clear();
}
inline ::Protocol::Player* S_ENTER_GAME::mutable_player(int index) {
  // @@protoc_insertion_point(field_mutable:Protocol.S_ENTER_GAME.player)
  return _impl_.player_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Protocol::Player >*
S_ENTER_GAME::mutable_player() {
  // @@protoc_insertion_point(field_mutable_list:Protocol.S_ENTER_GAME.player)
  return &_impl_.player_;
}
inline const ::Protocol::Player& S_ENTER_GAME::_internal_player(int index) const {
  return _impl_.player_.Get(index);
}
inline const ::Protocol::Player& S_ENTER_GAME::player(int index) const {
  // @@protoc_insertion_point(field_get:Protocol.S_ENTER_GAME.player)
  return _internal_player(index);
}
inline ::Protocol::Player* S_ENTER_GAME::_internal_add_player() {
  return _impl_.player_.Add();
}
inline ::Protocol::Player* S_ENTER_GAME::add_player() {
  ::Protocol::Player* _add = _internal_add_player();
  // @@protoc_insertion_point(field_add:Protocol.S_ENTER_GAME.player)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Protocol::Player >&
S_ENTER_GAME::player() const {
  // @@protoc_insertion_point(field_list:Protocol.S_ENTER_GAME.player)
  return _impl_.player_;
}
...
// uint64 playerIndex = 1;
inline void C_CHAT::clear_playerindex() {
  _impl_.playerindex_ = uint64_t{0u};
}
inline uint64_t C_CHAT::_internal_playerindex() const {
  return _impl_.playerindex_;
}
inline uint64_t C_CHAT::playerindex() const {
  // @@protoc_insertion_point(field_get:Protocol.C_CHAT.playerIndex)
  return _internal_playerindex();
}
inline void C_CHAT::_internal_set_playerindex(uint64_t value) {
  
  _impl_.playerindex_ = value;
}
inline void C_CHAT::set_playerindex(uint64_t value) {
  _internal_set_playerindex(value);
  // @@protoc_insertion_point(field_set:Protocol.C_CHAT.playerIndex)
}
...
inline double C_MOVE::_internal_x() const {
  return _impl_.x_;
}
inline double C_MOVE::x() const {
  // @@protoc_insertion_point(field_get:Protocol.C_MOVE.x)
  return _internal_x();
}
inline void C_MOVE::_internal_set_x(double value) {
  
  _impl_.x_ = value;
}
inline void C_MOVE::set_x(double value) {
...
inline double C_MOVE::_internal_y() const {
  return _impl_.y_;
}
inline double C_MOVE::y() const {
  // @@protoc_insertion_point(field_get:Protocol.C_MOVE.y)
  return _internal_y();
}
inline void C_MOVE::_internal_set_y(double value) {
  
  _impl_.y_ = value;
}
inline void C_MOVE::set_y(double value) {
...
inline double C_MOVE::_internal_z() const {
  return _impl_.z_;
}
inline double C_MOVE::z() const {
  // @@protoc_insertion_point(field_get:Protocol.C_MOVE.z)
  return _internal_z();
}
inline void C_MOVE::_internal_set_z(double value) {
  
  _impl_.z_ = value;
}
inline void C_MOVE::set_z(double value) {
  _internal_set_z(value);
  // @@protoc_insertion_point(field_set:Protocol.C_MOVE.z)
}

// double xRot = 5;
inline void C_MOVE::clear_xrot() {
  _impl_.xrot_ = 0;
}
inline double C_MOVE::_internal_xrot() const {
  return _impl_.xrot_;
}
inline double C_MOVE::xrot() const {
  // @@protoc_insertion_point(field_get:Protocol.C_MOVE.xRot)
  return _internal_xrot();
}
inline void C_MOVE::_internal_set_xrot(double value) {
  
  _impl_.xrot_ = value;
}
inline void C_MOVE::set_xrot(double value) {
  _internal_set_xrot(value);
  // @@protoc_insertion_point(field_set:Protocol.C_MOVE.xRot)
}
...
inline double C_MOVE::_internal_yrot() const {
  return _impl_.yrot_;
}
inline double C_MOVE::yrot() const {
  // @@protoc_insertion_point(field_get:Protocol.C_MOVE.yRot)
  return _internal_yrot();
}
inline void C_MOVE::_internal_set_yrot(double value) {
  
  _impl_.yrot_ = value;
}
inline void C_MOVE::set_yrot(double value) {
  _internal_set_yrot(value);
  // @@protoc_insertion_point(field_set:Protocol.C_MOVE.yRot)
}

// double zRot = 7;
inline void C_MOVE::clear_zrot() {
  _impl_.zrot_ = 0;
}
inline double C_MOVE::_internal_zrot() const {
  return _impl_.zrot_;
}
inline double C_MOVE::zrot() const {
  // @@protoc_insertion_point(field_get:Protocol.C_MOVE.zRot)
  return _internal_zrot();
}
inline void C_MOVE::_internal_set_zrot(double value) {
  
  _impl_.zrot_ = value;
}
inline void C_MOVE::set_zrot(double value) {
  _internal_set_zrot(value);
  // @@protoc_insertion_point(field_set:Protocol.C_MOVE.zRot)
}

// double speed = 8;
inline void C_MOVE::clear_speed() {
  _impl_.speed_ = 0;
}
inline double C_MOVE::_internal_speed() const {
  return _impl_.speed_;
}
inline double C_MOVE::speed() const {
  // @@protoc_insertion_point(field_get:Protocol.C_MOVE.speed)
  return _internal_speed();
}
inline void C_MOVE::_internal_set_speed(double value) {
  
  _impl_.speed_ = value;
}
inline void C_MOVE::set_speed(double value) {
  _internal_set_speed(value);
  // @@protoc_insertion_point(field_set:Protocol.C_MOVE.speed)
}

// bool moving = 9;
inline void C_MOVE::clear_moving() {
  _impl_.moving_ = false;
}
inline bool C_MOVE::_internal_moving() const {
  return _impl_.moving_;
}
inline bool C_MOVE::moving() const {
  // @@protoc_insertion_point(field_get:Protocol.C_MOVE.moving)
  return _internal_moving();
}
inline void C_MOVE::_internal_set_moving(bool value) {
  
  _impl_.moving_ = value;
}
inline void C_MOVE::set_moving(bool value) {
  _internal_set_moving(value);
  // @@protoc_insertion_point(field_set:Protocol.C_MOVE.moving)
}
...
inline double S_MOVE::_internal_x() const {
  return _impl_.x_;
}
inline double S_MOVE::x() const {
  // @@protoc_insertion_point(field_get:Protocol.S_MOVE.x)
  return _internal_x();
}
inline void S_MOVE::_internal_set_x(double value) {
  
  _impl_.x_ = value;
}
inline void S_MOVE::set_x(double value) {
  _internal_set_x(value);
...
inline double S_MOVE::_internal_y() const {
  return _impl_.y_;
}
inline double S_MOVE::y() const {
  // @@protoc_insertion_point(field_get:Protocol.S_MOVE.y)
  return _internal_y();
}
inline void S_MOVE::_internal_set_y(double value) {
  
  _impl_.y_ = value;
}
inline void S_MOVE::set_y(double value) {
  _internal_set_y(value);
...
inline double S_MOVE::_internal_z() const {
  return _impl_.z_;
}
inline double S_MOVE::z() const {
  // @@protoc_insertion_point(field_get:Protocol.S_MOVE.z)
  return _internal_z();
}
inline void S_MOVE::_internal_set_z(double value) {
  
  _impl_.z_ = value;
}
inline void S_MOVE::set_z(double value) {
  _internal_set_z(value);
  // @@protoc_insertion_point(field_set:Protocol.S_MOVE.z)
}

// double xRot = 5;
inline void S_MOVE::clear_xrot() {
  _impl_.xrot_ = 0;
}
inline double S_MOVE::_internal_xrot() const {
  return _impl_.xrot_;
}
inline double S_MOVE::xrot() const {
  // @@protoc_insertion_point(field_get:Protocol.S_MOVE.xRot)
  return _internal_xrot();
}
inline void S_MOVE::_internal_set_xrot(double value) {
  
  _impl_.xrot_ = value;
}
inline void S_MOVE::set_xrot(double value) {
  _internal_set_xrot(value);
  // @@protoc_insertion_point(field_set:Protocol.S_MOVE.xRot)
}
...
inline double S_MOVE::_internal_yrot() const {
  return _impl_.yrot_;
}
inline double S_MOVE::yrot() const {
  // @@protoc_insertion_point(field_get:Protocol.S_MOVE.yRot)
  return _internal_yrot();
}
inline void S_MOVE::_internal_set_yrot(double value) {
  
  _impl_.yrot_ = value;
}
inline void S_MOVE::set_yrot(double value) {
  _internal_set_yrot(value);
  // @@protoc_insertion_point(field_set:Protocol.S_MOVE.yRot)
}

// double zRot = 7;
inline void S_MOVE::clear_zrot() {
  _impl_.zrot_ = 0;
}
inline double S_MOVE::_internal_zrot() const {
  return _impl_.zrot_;
}
inline double S_MOVE::zrot() const {
  // @@protoc_insertion_point(field_get:Protocol.S_MOVE.zRot)
  return _internal_zrot();
}
inline void S_MOVE::_internal_set_zrot(double value) {
  
  _impl_.zrot_ = value;
}
inline void S_MOVE::set_zrot(double value) {
  _internal_set_zrot(value);
  // @@protoc_insertion_point(field_set:Protocol.S_MOVE.zRot)
}

// double speed = 8;
inline void S_MOVE::clear_speed() {
  _impl_.speed_ = 0;
}
inline double S_MOVE::_internal_speed() const {
  return _impl_.speed_;
}
inline double S_MOVE::speed() const {
  // @@protoc_insertion_point(field_get:Protocol.S_MOVE.speed)
  return _internal_speed();
}
inline void S_MOVE::_internal_set_speed(double value) {
  
  _impl_.speed_ = value;
}
inline void S_MOVE::set_speed(double value) {
  _internal_set_speed(value);
  // @@protoc_insertion_point(field_set:Protocol.S_MOVE.speed)
}

// bool moving = 9;
inline void S_MOVE::clear_moving() {
  _impl_.moving_ = false;
}
inline bool S_MOVE::_internal_moving() const {
  return _impl_.moving_;
}
inline bool S_MOVE::moving() const {
  // @@protoc_insertion_point(field_get:Protocol.S_MOVE.moving)
  return _internal_moving();
}
inline void S_MOVE::_internal_set_moving(bool value) {
  
  _impl_.moving_ = value;
}
inline void S_MOVE::set_moving(bool value) {
  _internal_set_moving(value);
  // @@protoc_insertion_point(field_set:Protocol.S_MOVE.moving)
}
