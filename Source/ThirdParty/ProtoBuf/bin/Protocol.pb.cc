...
PROTOBUF_CONSTEXPR S_LOGIN::S_LOGIN(
  ...
  , /*decltype(_impl_.connectingplayerindex_)*/uint64_t{0u}
...
PROTOBUF_CONSTEXPR C_MOVE::C_MOVE(
  ...
  , /*decltype(_impl_.xrot_)*/0
  , /*decltype(_impl_.yrot_)*/0
  , /*decltype(_impl_.zrot_)*/0
...
const uint32_t TableStruct_Protocol_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::Protocol::S_LOGIN, _impl_.connectingplayerindex_),
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::Protocol::C_CHAT, _impl_.playerindex_),
  ...
  PROTOBUF_FIELD_OFFSET(::Protocol::C_MOVE, _impl_.xrot_),
  PROTOBUF_FIELD_OFFSET(::Protocol::C_MOVE, _impl_.yrot_),
  PROTOBUF_FIELD_OFFSET(::Protocol::C_MOVE, _impl_.zrot_),
  PROTOBUF_FIELD_OFFSET(::Protocol::C_MOVE, _impl_.speed_),
  PROTOBUF_FIELD_OFFSET(::Protocol::C_MOVE, _impl_.moving_),
  ~0u,  // no _has_bits_
  ...
  PROTOBUF_FIELD_OFFSET(::Protocol::S_MOVE, _impl_.xrot_),
  PROTOBUF_FIELD_OFFSET(::Protocol::S_MOVE, _impl_.yrot_),
  PROTOBUF_FIELD_OFFSET(::Protocol::S_MOVE, _impl_.zrot_),
  PROTOBUF_FIELD_OFFSET(::Protocol::S_MOVE, _impl_.speed_),
  PROTOBUF_FIELD_OFFSET(::Protocol::S_MOVE, _impl_.moving_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::Protocol::Player)},
  { 9, -1, -1, sizeof(::Protocol::C_LOGIN)},
  { 15, -1, -1, sizeof(::Protocol::S_LOGIN)},
  { 24, -1, -1, sizeof(::Protocol::C_ENTER_GAME)},
  { 31, -1, -1, sizeof(::Protocol::S_ENTER_GAME)},
...
const char descriptor_table_protodef_Protocol_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "id\030\001 \001(\004\022\014\n\004name\030\002 \001(\t\022(\n\nplayertype\030\003 \001"
  "(\0162\024.Protocol.PlayerType\"\t\n\007C_LOGIN\"[\n\007S"
  "_LOGIN\022\017\n\007success\030\001 \001(\010\022\035\n\025ConnectingPla"
  "yerIndex\030\002 \001(\004\022 \n\006player\030\003 \003(\0132\020.Protoco"
  "l.Player\"#\n\014C_ENTER_GAME\022\023\n\013playerIndex\030"
  "\001 \001(\004\"A\n\014S_ENTER_GAME\022\017\n\007success\030\001 \001(\010\022 "
  "\n\006player\030\002 \003(\0132\020.Protocol.Player\"*\n\006C_CH"
  "AT\022\023\n\013playerIndex\030\001 \001(\004\022\013\n\003msg\030\002 \001(\t\"\'\n\006"
  "S_CHAT\022\020\n\010playerId\030\001 \001(\004\022\013\n\003msg\030\002 \001(\t\"\204\001"
  "\n\006C_MOVE\022\020\n\010playerId\030\001 \001(\004\022\t\n\001x\030\002 \001(\001\022\t\n"
  "\001y\030\003 \001(\001\022\t\n\001z\030\004 \001(\001\022\014\n\004xRot\030\005 \001(\001\022\014\n\004yRo"
  "t\030\006 \001(\001\022\014\n\004zRot\030\007 \001(\001\022\r\n\005speed\030\010 \001(\001\022\016\n\006"
  "moving\030\t \001(\010\"\204\001\n\006S_MOVE\022\020\n\010playerId\030\001 \001("
  "\004\022\t\n\001x\030\002 \001(\001\022\t\n\001y\030\003 \001(\001\022\t\n\001z\030\004 \001(\001\022\014\n\004xR"
  "ot\030\005 \001(\001\022\014\n\004yRot\030\006 \001(\001\022\014\n\004zRot\030\007 \001(\001\022\r\n\005"
  "speed\030\010 \001(\001\022\016\n\006moving\030\t \001(\010*h\n\nPlayerTyp"
  "e\022\024\n\020PLAYER_TYPE_NONE\020\000\022\026\n\022PLAYER_TYPE_K"
  "NIHGT\020\001\022\024\n\020PLAYER_TYPE_MAGE\020\002\022\026\n\022PLAYER_"
  "TYPE_ARCHER\020\003b\006proto3"
  ;
static ::_pbi::once_flag descriptor_table_Protocol_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_Protocol_2eproto = {
    false, false, 781, descriptor_table_protodef_Protocol_2eproto,
    "Protocol.proto",
...
S_LOGIN::S_LOGIN(const S_LOGIN& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.connectingplayerindex_){}
    , decltype(_impl_.success_){}
    , /*decltype(_impl_._cached_size_)*/{}};

  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::memcpy(&_impl_.connectingplayerindex_, &from._impl_.connectingplayerindex_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.success_) -
    reinterpret_cast<char*>(&_impl_.connectingplayerindex_)) + sizeof(_impl_.success_));
...
// @@protoc_insertion_point(message_clear_start:Protocol.S_LOGIN)
  ...
  ::memset(&_impl_.connectingplayerindex_, 0, static_cast<size_t>(
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 8)) {
          _impl_.success_ = (bool)::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 16)) {
          _impl_.connectingplayerindex_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* S_LOGIN::_InternalSerialize(
  ...
  // uint64 ConnectingPlayerIndex = 2;
  if (this->_internal_connectingplayerindex() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt64ToArray(2, this->_internal_connectingplayerindex(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:Protocol.S_LOGIN)
  ...
  // uint64 ConnectingPlayerIndex = 2;
  if (this->_internal_connectingplayerindex() != 0) {
    total_size += ::_pbi::WireFormatLite::UInt64SizePlusOne(this->_internal_connectingplayerindex());
  }
...
void S_LOGIN::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (from._internal_connectingplayerindex() != 0) {
    _this->_internal_set_connectingplayerindex(from._internal_connectingplayerindex());
  }
...
void S_LOGIN::InternalSwap(S_LOGIN* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      ...
      - PROTOBUF_FIELD_OFFSET(S_LOGIN, _impl_.connectingplayerindex_)>(
          reinterpret_cast<char*>(&_impl_.connectingplayerindex_),
          reinterpret_cast<char*>(&other->_impl_.connectingplayerindex_));
}
...
C_MOVE::C_MOVE(const C_MOVE& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.y_){}
    , decltype(_impl_.z_){}
    , decltype(_impl_.xrot_){}
    , decltype(_impl_.yrot_){}
    , decltype(_impl_.zrot_){}
  ...
  ::memcpy(&_impl_.playerid_, &from._impl_.playerid_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.moving_) -
    reinterpret_cast<char*>(&_impl_.playerid_)) + sizeof(_impl_.moving_));
...
// @@protoc_insertion_point(message_clear_start:Protocol.C_MOVE)
  ...
  ::memset(&_impl_.playerid_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&_impl_.moving_) -
      reinterpret_cast<char*>(&_impl_.playerid_)) + sizeof(_impl_.moving_));
  _internal_metadata_.Clear<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}
    ...
    switch (tag >> 3) {
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 41)) {
          _impl_.xrot_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<double>(ptr);
          ptr += sizeof(double);
        } else
          goto handle_unusual;
        continue;
      ...
      case 6:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 49)) {
          _impl_.yrot_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<double>(ptr);
          ptr += sizeof(double);
        } else
          goto handle_unusual;
        continue;
      ...
      case 7:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 57)) {
          _impl_.zrot_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<double>(ptr);
          ptr += sizeof(double);
        } else
          goto handle_unusual;
        continue;
      ...
      case 9:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 72)) {
          _impl_.moving_ = (bool)::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* C_MOVE::_InternalSerialize(
  ...
  // double xRot = 5;
  static_assert(sizeof(uint64_t) == sizeof(double), "Code assumes uint64_t and double are the same size.");
  double tmp_xrot = this->_internal_xrot();
  uint64_t raw_xrot;
  memcpy(&raw_xrot, &tmp_xrot, sizeof(tmp_xrot));
  if (raw_xrot != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteDoubleToArray(5, this->_internal_xrot(), target);
  }

  // double yRot = 6;
  static_assert(sizeof(uint64_t) == sizeof(double), "Code assumes uint64_t and double are the same size.");
  double tmp_yrot = this->_internal_yrot();
  uint64_t raw_yrot;
  memcpy(&raw_yrot, &tmp_yrot, sizeof(tmp_yrot));
  if (raw_yrot != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteDoubleToArray(6, this->_internal_yrot(), target);
  }

  // double zRot = 7;
  static_assert(sizeof(uint64_t) == sizeof(double), "Code assumes uint64_t and double are the same size.");
  double tmp_zrot = this->_internal_zrot();
  uint64_t raw_zrot;
  memcpy(&raw_zrot, &tmp_zrot, sizeof(tmp_zrot));
  if (raw_zrot != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteDoubleToArray(7, this->_internal_zrot(), target);
  }
  ...
  if (this->_internal_moving() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteBoolToArray(9, this->_internal_moving(), target);
  }
...
void C_MOVE::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  static_assert(sizeof(uint64_t) == sizeof(double), "Code assumes uint64_t and double are the same size.");
  double tmp_xrot = from._internal_xrot();
  uint64_t raw_xrot;
  memcpy(&raw_xrot, &tmp_xrot, sizeof(tmp_xrot));
  if (raw_xrot != 0) {
    _this->_internal_set_xrot(from._internal_xrot());
  }
  static_assert(sizeof(uint64_t) == sizeof(double), "Code assumes uint64_t and double are the same size.");
  double tmp_yrot = from._internal_yrot();
  uint64_t raw_yrot;
  memcpy(&raw_yrot, &tmp_yrot, sizeof(tmp_yrot));
  if (raw_yrot != 0) {
    _this->_internal_set_yrot(from._internal_yrot());
  }
  static_assert(sizeof(uint64_t) == sizeof(double), "Code assumes uint64_t and double are the same size.");
  double tmp_zrot = from._internal_zrot();
  uint64_t raw_zrot;
  memcpy(&raw_zrot, &tmp_zrot, sizeof(tmp_zrot));
  if (raw_zrot != 0) {
    _this->_internal_set_zrot(from._internal_zrot());
  }
  static_assert(sizeof(uint64_t) == sizeof(double), "Code assumes uint64_t and double are the same size.");
...
void C_MOVE::InternalSwap(C_MOVE* other) {
  ...
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(C_MOVE, _impl_.moving_)
      + sizeof(C_MOVE::_impl_.moving_)
...
void S_MOVE::InternalSwap(S_MOVE* other) {
  ...
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(S_MOVE, _impl_.moving_)
      + sizeof(S_MOVE::_impl_.moving_)
